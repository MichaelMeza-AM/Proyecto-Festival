...
Nota: Este repositorio contiene específicamente el código fuente de "Compra" y su responsabilidad es manejar la lógica de reserva de entradas, vinculando al usuario con la presentación y calculando los subtotales base.
...
* Interfaz de usuario: http://localhost:8097/doc/swagger-ui.html
* Formato JSON: http://localhost:8097/v3/api-docs
...
* SPRING_DATASOURCE_URL: Cadena de conexión a MySQL (Ej: jdbc:mysql://host.docker.internal:3306/bd_compras).
