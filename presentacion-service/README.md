...
Nota: Este repositorio contiene específicamente el código fuente de "Presentacion" y su responsabilidad es la construcción del line-up, vinculando a un artista con un escenario en una fecha y horario específicos.servicios internos.
...
* Interfaz de usuario: http://localhost:8095/doc/swagger-ui.html
* Formato JSON: http://localhost:8095/v3/api-docs
...
* SPRING_DATASOURCE_URL: Cadena de conexión a MySQL (Ej: jdbc:mysql://host.docker.internal:3306/bd_presentaciones).
