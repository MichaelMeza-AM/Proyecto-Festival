...
Nota: Este repositorio contiene específicamente el código fuente de "Pago" y su responsabilidad es procesar el modelo financiero de la compra. Verifica que no existan cobros duplicados y sella la transacción como un registro contable inmutable.
...
* SPRING_DATASOURCE_URL: Cadena de conexión a MySQL (Ej: jdbc:mysql://host.docker.internal:3306/bd_pagos).
