...
Nota: Este repositorio contiene específicamente el código fuente de "Usuario" y su responsabilidad es mantener la persistencia y el CRUD de los datos personales y perfiles de los asistentes al festival.
...
* Interfaz de usuario: http://localhost:8091/doc/swagger-ui.html
* Formato JSON: http://localhost:8091/v3/api-docs
...
* SPRING_DATASOURCE_URL: Cadena de conexión a MySQL (Ej: jdbc:mysql://host.docker.internal:3306/bd_usuarios).
