...
Nota: Este repositorio contiene específicamente el código fuente de "Artista" y Su responsabilidad es la gestión del catálogo musical, manteniendo el registro de las bandas, solistas y sus requerimientos técnicos.
...
* Interfaz de usuario: http://localhost:8092/doc/swagger-ui.html
* Formato JSON: http://localhost:8092/v3/api-docs
...
* SPRING_DATASOURCE_URL: Cadena de conexión a MySQL (Ej: jdbc:mysql://host.docker.internal:3306/bd_artistas).
